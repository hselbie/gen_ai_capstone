...
def chat():
    ...
    return render_template('chat.html', server_response = 'test',looker_sso_url=sso_url, name=name, room=room, tables=[df.to_html(classes='data')], titles=df.columns.values)
