...
class CreateLookerEmbedding():
    ...
    def execute(self):
        ...
        # self.query_question = ['What are dashboards that list sales populations?']
        x,y = self.encode_text_to_embedding_batched(self.query_question, api_calls_per_second=10, batch_size=5)
